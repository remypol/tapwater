...
import { FileText, ChevronRight, AlertTriangle, Droplets, FlaskConical, Building2, TestTube, Microscope, Scale, ShieldCheck, Sparkles, Home, ShieldAlert, GlassWater, Waves, HelpCircle, PoundSterling, Wrench, GitCompare, Package, Zap } from "lucide-react";
...
const GUIDES = [
  ...
  },
  {
    ...
    subtitle: "Best-before dates explained: quality marker, not safety deadline",
    icon: GlassWater,
    iconColor: "text-indigo-600",
    iconBg: "bg-indigo-50",
  },
  {
    ...
    subtitle: "What harvested rain contains and what boiling does not fix",
    icon: Droplets,
    iconColor: "text-cyan-600",
    iconBg: "bg-cyan-50",
  },
  {
    ...
    subtitle: "The chemistry behind the brand, compared with UK tap water",
    icon: Scale,
    iconColor: "text-violet-600",
    iconBg: "bg-violet-50",
  },
