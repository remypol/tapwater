  ...
  return (
    <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold text-slate-900 mb-6">Our Data Sources</h1>
        ...
        <p className="text-base text-slate-600 leading-relaxed mb-4">
          <strong className="text-slate-800">This is our primary source.</strong> The Drinking Water
        ...
        <p className="text-base text-slate-600 leading-relaxed mb-4">
          <strong className="text-slate-800">This is a supplementary source.</strong> The
        ...
        <h2 className="text-xl font-bold text-slate-900 mt-10 mb-4">Postcode Mapping</h2>
        <p className="text-base text-slate-600 leading-relaxed mb-4">
        ...
        <ul className="list-disc pl-5 mb-4 space-y-1 text-base text-slate-600 leading-relaxed">
          <li>
            <strong className="text-slate-800">Water UK postcode lookup</strong> — maps postcodes
            to water company and supply zone identifiers, maintained by the industry body Water UK.
          </li>
          <li>
            <strong className="text-slate-800">ONS Postcode Directory (ONSPD)</strong> — the Office
        ...
        <h2 className="text-xl font-bold text-slate-900 mt-10 mb-4">Update Frequency</h2>
        <p className="text-base text-slate-600 leading-relaxed mb-4">
        ...
        <ul className="list-disc pl-5 mb-4 space-y-1 text-base text-slate-600 leading-relaxed">
          <li>
            <strong className="text-slate-800">Environment Agency API</strong> — checked daily for
            new observations; new measurements are incorporated within 24 hours of publication.
          </li>
          <li>
            <strong className="text-slate-800">Water company postcode lookups</strong> — re-scraped
            weekly to capture supply zone boundary changes and new postcode assignments.
          </li>
          <li>
            <strong className="text-slate-800">DWI drinking water data</strong> — ingested on a
        ...
        <h2 className="text-xl font-bold text-slate-900 mt-10 mb-4">Open Data</h2>
        <p className="text-base text-slate-600 leading-relaxed mb-4">
