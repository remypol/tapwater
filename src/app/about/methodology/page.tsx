  ...
  return (
    <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold font-display italic text-[var(--color-ink)] mb-6">
        ...
        <h2 className="text-xl font-bold text-[var(--color-ink)] mt-10 mb-4">Data Sources</h2>
        <p className="text-base text-[var(--color-body)] leading-relaxed mb-4">
          The overall score is derived from two layers of data, combined with fixed weights:
        </p>
        <ul className="list-disc pl-5 mb-4 space-y-1 text-base text-[var(--color-body)] leading-relaxed">
          <li>
            <strong className="text-[var(--color-ink)]">Drinking Water (80% weight)</strong> — data from the
          ...
          <li>
            <strong className="text-[var(--color-ink)]">Environmental Context (20% weight)</strong> — data
        ...
        <h2 className="text-xl font-bold text-[var(--color-ink)] mt-10 mb-4">Scoring Formula</h2>
        <p className="text-base text-[var(--color-body)] leading-relaxed mb-4">
        ...
        <div className="bg-[var(--color-wash)] border border-[var(--color-rule)] rounded-lg px-5 py-4 mb-4 font-mono text-sm text-[var(--color-body)]">
        ...
        <h3 className="text-lg font-semibold text-[var(--color-ink)] mt-6 mb-2">Tier 1 — Weight 3.0</h3>
        <p className="text-base text-[var(--color-body)] leading-relaxed mb-4">
        ...
        <h3 className="text-lg font-semibold text-[var(--color-ink)] mt-6 mb-2">Tier 2 — Weight 2.0</h3>
        <p className="text-base text-[var(--color-body)] leading-relaxed mb-4">
        ...
        <h3 className="text-lg font-semibold text-[var(--color-ink)] mt-6 mb-2">Tier 3 — Weight 1.0</h3>
        <p className="text-base text-[var(--color-body)] leading-relaxed mb-4">
        ...
        <h2 className="text-xl font-bold text-[var(--color-ink)] mt-10 mb-4">Grade Scale</h2>
        <p className="text-base text-[var(--color-body)] leading-relaxed mb-4">
          Scores are mapped to a five-band grade for easier interpretation:
        </p>
        <div className="overflow-x-auto mb-4">
          <table className="w-full text-sm text-left border border-[var(--color-rule)] rounded-lg overflow-hidden">
            <thead>
              <tr className="bg-[var(--color-wash)] text-[var(--color-body)] font-semibold">
                <th className="px-4 py-3 border-b border-[var(--color-rule)]">Score range</th>
                <th className="px-4 py-3 border-b border-[var(--color-rule)]">Grade</th>
                <th className="px-4 py-3 border-b border-[var(--color-rule)]">What it means</th>
              </tr>
            </thead>
            <tbody className="text-[var(--color-body)] divide-y divide-[var(--color-rule)]">
              <tr>
        ...
        <h2 className="text-xl font-bold text-[var(--color-ink)] mt-10 mb-4">Transparency</h2>
        <p className="text-base text-[var(--color-body)] leading-relaxed mb-4">
        ...
        <h2 className="text-xl font-bold text-[var(--color-ink)] mt-10 mb-4">Limitations</h2>
        <p className="text-base text-[var(--color-body)] leading-relaxed mb-4">
        ...
        <ul className="list-disc pl-5 mb-4 space-y-1 text-base text-[var(--color-body)] leading-relaxed">
          <li>
            <strong className="text-[var(--color-ink)]">Infrastructure age.</strong> Lead pipes in older
          ...
          <li>
            <strong className="text-[var(--color-ink)]">Private water supplies.</strong> Properties served by
            private boreholes or springs are not covered by DWI data and are not included in our
            scores.
          </li>
          <li>
            <strong className="text-[var(--color-ink)]">Sampling frequency.</strong> Some parameters are
            tested quarterly or annually. The score reflects the most recent data available, which
            may not capture very recent changes.
          </li>
          <li>
            <strong className="text-[var(--color-ink)]">Emerging contaminants.</strong> Regulatory limits
          ...
          <li>
            <strong className="text-[var(--color-ink)]">This is not medical advice.</strong> If you have
