    ...
    <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <ul className="list-disc pl-5 mb-4 space-y-1 text-base text-body leading-relaxed">
          <li>
            <strong className="text-ink">Drinking Water (80% weight)</strong> — data from the
          ...
          <li>
            <strong className="text-ink">Environmental Context (20% weight)</strong> — data
        ...
        <div className="bg-wash border border-rule rounded-lg px-5 py-4 mb-4 font-mono text-sm text-body">
        ...
        <h3 className="text-lg font-semibold text-ink mt-6 mb-2">Tier 1 — Weight 3.0</h3>
        <p className="text-base text-body leading-relaxed mb-4">
        ...
        <h3 className="text-lg font-semibold text-ink mt-6 mb-2">Tier 2 — Weight 2.0</h3>
        <p className="text-base text-body leading-relaxed mb-4">
        ...
        <h3 className="text-lg font-semibold text-ink mt-6 mb-2">Tier 3 — Weight 1.0</h3>
        <p className="text-base text-body leading-relaxed mb-4">
        ...
        <div className="overflow-x-auto mb-4">
          <table className="w-full text-sm text-left border border-rule rounded-lg overflow-hidden">
            <thead>
              <tr className="bg-wash text-body font-semibold">
                <th className="px-4 py-3 border-b border-rule">Score range</th>
                <th className="px-4 py-3 border-b border-rule">Grade</th>
                <th className="px-4 py-3 border-b border-rule">What it means</th>
              </tr>
            </thead>
        ...
        <ul className="list-disc pl-5 mb-4 space-y-1 text-base text-body leading-relaxed">
          <li>
            <strong className="text-ink">Infrastructure age.</strong> Lead pipes in older
          ...
          <li>
            <strong className="text-ink">Private water supplies.</strong> Properties served by
            private boreholes or springs are not covered by DWI data and are not included in our
            scores.
          </li>
          <li>
            <strong className="text-ink">Sampling frequency.</strong> Some parameters are
            tested quarterly or annually. The score reflects the most recent data available, which
            may not capture very recent changes.
          </li>
          <li>
            <strong className="text-ink">Emerging contaminants.</strong> Regulatory limits
          ...
          <li>
            <strong className="text-ink">This is not medical advice.</strong> If you have
