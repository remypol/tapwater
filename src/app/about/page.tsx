  ...
  return (
    <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold font-display italic text-[var(--color-ink)] mb-6">About TapWater.uk</h1>
        ...
        <h2 className="text-xl font-bold text-[var(--color-ink)] mt-10 mb-4">Our Mission</h2>
        <p className="text-base text-[var(--color-body)] leading-relaxed mb-4">
        ...
        <h2 className="text-xl font-bold text-[var(--color-ink)] mt-10 mb-4">How It Works</h2>
        <p className="text-base text-[var(--color-body)] leading-relaxed mb-4">
        ...
        <ul className="list-disc pl-5 mb-4 space-y-1 text-base text-[var(--color-body)] leading-relaxed">
          <li>
            <strong className="text-[var(--color-ink)]">Drinking Water Inspectorate (DWI)</strong> — the
          ...
          <li>
            <strong className="text-[var(--color-ink)]">Water company data</strong> — postcode-level supply
          ...
          <li>
            <strong className="text-[var(--color-ink)]">Environment Agency monitoring</strong> — supplementary
        ...
        <p className="text-base text-[var(--color-body)] leading-relaxed mb-4">
          ...
          <Link href="/about/data-sources" className="text-[var(--color-accent)] underline hover:text-[var(--color-accent-hover)]">
            data sources
          </Link>{' '}
          page, and how we calculate quality scores on our{' '}
          <Link href="/about/methodology" className="text-[var(--color-accent)] underline hover:text-[var(--color-accent-hover)]">
            methodology
          </Link>{' '}
          page.
        </p>

        <h2 className="text-xl font-bold text-[var(--color-ink)] mt-10 mb-4">What We Are Not</h2>
        <p className="text-base text-[var(--color-body)] leading-relaxed mb-4">
