  ...
  return (
    <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
      <div className="max-w-3xl mx-auto">
        ...
        <h2 className="text-xl font-bold text-slate-900 mt-10 mb-4">How Affiliate Links Work</h2>
        <p className="text-base text-slate-600 leading-relaxed mb-6">
        ...
        <h2 className="text-xl font-bold text-slate-900 mt-10 mb-4">Our Editorial Independence</h2>
        <p className="text-base text-slate-600 leading-relaxed mb-6">
        ...
        <h2 className="text-xl font-bold text-slate-900 mt-10 mb-4">Compliance</h2>
        <p className="text-base text-slate-600 leading-relaxed mb-6">
        ...
        <h2 className="text-xl font-bold text-slate-900 mt-10 mb-4">Questions</h2>
        <p className="text-base text-slate-600 leading-relaxed mb-6">
