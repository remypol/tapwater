...
> = {
  ...
  reverse_osmosis: [
    ...
    },
    {
      ...
      answer:
        "The systems we review run from £450 to £650 up front. Budget roughly £100-£150 a year for replacement filters depending on the model, counting a share of the main RO filter, which lasts about two years. Tankless designs cost more up front but save cupboard space and waste less water.",
    },
    {
