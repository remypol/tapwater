  ...
  return (
    <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
      <div className="max-w-3xl mx-auto">
        ...
        <h2 className="text-xl font-bold text-slate-900 mt-10 mb-4">Information We Collect</h2>
        <p className="text-base text-slate-600 leading-relaxed mb-4">
          We collect limited information in order to provide and improve our service:
        </p>
        <ul className="list-disc pl-5 mb-6 space-y-2 text-base text-slate-600 leading-relaxed">
          <li>
            <strong className="text-slate-800">Postcode searches.</strong> When you search a
          ...
          <li>
            <strong className="text-slate-800">Email address.</strong> If you sign up for water
          ...
          <li>
            <strong className="text-slate-800">Usage data.</strong> We collect standard server
          ...
          <li>
            <strong className="text-slate-800">Cookies.</strong> We use strictly necessary cookies
            to operate the site. We may also use analytics cookies; where we do, we will ask for
            your consent first.
          </li>
        </ul>

        <h2 className="text-xl font-bold text-slate-900 mt-10 mb-4">How We Use Your Information</h2>
        <p className="text-base text-slate-600 leading-relaxed mb-4">We use the information we collect to:</p>
        <ul className="list-disc pl-5 mb-6 space-y-2 text-base text-slate-600 leading-relaxed">
        ...
        <h2 className="text-xl font-bold text-slate-900 mt-10 mb-4">Your Rights</h2>
        <p className="text-base text-slate-600 leading-relaxed mb-4">
        ...
        <h2 className="text-xl font-bold text-slate-900 mt-10 mb-4">Changes to This Policy</h2>
        <p className="text-base text-slate-600 leading-relaxed mb-6">
