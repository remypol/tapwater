...
const CONTAMINANT_CARDS = [
  ...
  },
  {
    ...
    tagline: "UK limit: 0.01 mg/L",
    danger: true,
    description: "Group 1 carcinogen found naturally in groundwater, especially in Cornwall and Devon. Linked to skin, bladder and lung cancers.",
  },
  {
    slug: "manganese",
    name: "Manganese",
    tagline: "UK limit: 0.05 mg/L",
    danger: false,
    description: "Common cause of brown/black water. Neurological effects in infants at elevated levels. WHO lowered guideline in 2022.",
  },
  {
    slug: "iron",
    name: "Iron",
    tagline: "UK limit: 0.2 mg/L",
    danger: false,
    description: "Most common cause of brown/orange water. From aging cast iron mains. Aesthetic standard rather than health-based limit.",
  },
  {
    slug: "mercury",
    name: "Mercury",
    tagline: "UK limit: 0.001 mg/L",
    danger: true,
    description: "Potent neurotoxin damaging the nervous system and kidneys. UK limit is six times stricter than the WHO guideline.",
  },
  {
    slug: "pesticides",
    name: "Pesticides",
    tagline: "UK limit: 0.1 µg/L each",
    danger: false,
    description: "Agricultural chemicals including metaldehyde, clopyralid and MCPA. One of the most common causes of regulatory failures.",
  },
  {
    slug: "microplastics",
    name: "Microplastics",
    tagline: "No UK limit set",
    danger: false,
    description: "Emerging contaminant from textiles, tyres and plastic breakdown. No regulatory limit yet. EU will require monitoring from 2026.",
  },
  {
    slug: "nitrite",
    name: "Nitrite",
    tagline: "UK limit: 0.5 mg/L",
    danger: true,
    description: "More toxic than nitrate. Can form in distribution pipes. Poses blue baby syndrome risk to infants under three months.",
  },
  {
    slug: "turbidity",
    name: "Turbidity",
    tagline: "UK limit: 4 NTU",
    danger: false,
    description: "Water cloudiness that shields bacteria from disinfection. Not harmful itself but indicates possible treatment problems.",
  },
  {
    slug: "aluminium",
    name: "Aluminium",
    tagline: "UK limit: 0.2 mg/L",
    danger: false,
    description: "From aluminium sulphate used in water treatment. Debated but inconclusive link to Alzheimer's disease.",
  },
  {
    slug: "coliform",
    ...
    tagline: "Zero tolerance",
    danger: true,
    description: "Indicator bacteria with zero-tolerance policy. Detection signals possible treatment failure and triggers immediate investigation.",
  },
  {
    slug: "cadmium",
    name: "Cadmium",
    tagline: "UK limit: 0.005 mg/L",
    danger: true,
    description: "Group 1 carcinogen that accumulates in the kidneys. Can leach from galvanised pipes. Causes bone demineralisation.",
  },
  {
    slug: "chromium",
    name: "Chromium",
    tagline: "UK limit: 0.05 mg/L",
    danger: true,
    description: "Hexavalent form is carcinogenic. EU tightening limit to 0.025 mg/L from 2036. From chrome plating and leather tanning.",
  },
];
